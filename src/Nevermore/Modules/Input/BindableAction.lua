...
function BindableAction:BindFunction(Name, Function)
	...
	-- Did some tests. When the BindableAction is GCed, this will also GC the
  -- signal and method. So Maid:DoCleaning() need not be called to finalize GC
  -- even with anonymous functions.
